...
import np.playground.desktopapp.core.view.*;
import np.playground.desktopapp.core.view.AddModulePresenter;
import np.playground.desktopapp.core.view.AddModuleView;
import np.playground.desktopapp.core.view.FXDesktopPresenter;
import np.playground.desktopapp.core.view.FXDesktopView;
import np.playground.desktopapp.core.view.TaskBarPresenter;
import np.playground.desktopapp.core.view.TaskBarView;
